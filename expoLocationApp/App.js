...
const SERVER_URL = "https://1ac1ec8c.ngrok.io/";
...
export default class App extends Component {
 ...
 async componentDidMount() {
   try {
     const res = await fetch(`${SERVER_URL}`).then(res => res.json());
...
//In order for this to work, we have to make ngrok listen on port 4000 after running project:  "reactnativeserver"